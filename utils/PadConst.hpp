...
extern const char *HID_NV_STRING;
...
extern const u8 HID_NV_BUTTON_A[];
extern const u8 HID_NV_BUTTON_B[];
extern const u8 HID_NV_BUTTON_X[];
extern const u8 HID_NV_BUTTON_Y[];

extern const u8 HID_NV_BUTTON_L1[];
extern const u8 HID_NV_BUTTON_L2[];
extern const u8 HID_NV_BUTTON_L3[];
extern const u8 HID_NV_BUTTON_R1[];
extern const u8 HID_NV_BUTTON_R2[];
extern const u8 HID_NV_BUTTON_R3[];

extern const u8 HID_NV_BUTTON_FRONT[];
extern const u8 HID_NV_BUTTON_BACK[];

extern const u8 HID_NV_BUTTON_DPAD_TYPE[];
extern const u8 HID_NV_BUTTON_DPAD_N[];
extern const u8 HID_NV_BUTTON_DPAD_NE[];
extern const u8 HID_NV_BUTTON_DPAD_E[];
extern const u8 HID_NV_BUTTON_DPAD_SE[];
extern const u8 HID_NV_BUTTON_DPAD_S[];
extern const u8 HID_NV_BUTTON_DPAD_SW[];
extern const u8 HID_NV_BUTTON_DPAD_W[];
extern const u8 HID_NV_BUTTON_DPAD_NW[];
extern const u8 HID_NV_BUTTON_DPAD_NEUTRAL[];

extern const u8 HID_NV_BUTTON_GUIDE[];

extern const u8 HID_NV_STICK_L_X[STICK_CONF_ENUM_MAXVALUE];
extern const u8 HID_NV_STICK_L_Y[STICK_CONF_ENUM_MAXVALUE];
extern const u8 HID_NV_STICK_R_X[STICK_CONF_ENUM_MAXVALUE];
extern const u8 HID_NV_STICK_R_Y[STICK_CONF_ENUM_MAXVALUE];
